...
class RoadInventoryDataController extends Controller
{
    ...
    public function create()
    {
        if (auth()->user()->role == 'staff') {
            ...
            return view('pages.dataInventarisJalan.create', [
                ...
                'streets' => [
                    'asphaltStreets' => AsphaltStreetData::all(),
                    'soilStreets' => SoilsStreetData::all(),
                ],
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'saluranKiriJenis' => 'required|integer|in:1,2,3,4,5',
            'saluranKananJenis' => 'required|integer|in:1,2,3,4,5',
    ...
    public function edit(RoadInventoryData $roadInventoryData)
    {
        ...
        return view('pages.dataInventarisJalan.edit', [
            'title' => 'Edit Data Inventaris Jaringan Jalan',
