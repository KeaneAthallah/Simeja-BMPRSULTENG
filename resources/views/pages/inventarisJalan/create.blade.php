        ...
        <div class="rounded-2xl">
            ...
            <div class="container w-full max-w-full mx-auto px-2">
                ...
                <div id='recipients'
                    ...
                    <form action="{{ route('inventarisJalan.store') }}" method="post">
                        @csrf
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="dariPatokKm" name="dariPatokKm"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="069690" value="{{ old('dariPatokKm') }}" />
                            </div>
                            <div>
                                <label for="date"
                            ...
                            <div>
                                ...
                                <input type="text" id="kePatokKm" name="kePatokKm"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="099000" value="{{ old('kePatokKm') }}" />
                            </div>
                            <div class="mb-4">
                                <label for="surveyor"
