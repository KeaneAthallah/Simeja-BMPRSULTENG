...
<body>
    <div class="container w-full max-w-full mx-auto px-2">
        ...
        @endif
        <!--Card-->
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-nord4 dark:bg-nord3 text-nord0 dark:text-nord6">
            <form action="#" method="POST">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="noRuas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor
                            Ruas</label>
                    ...
                    <div>
                        <label for="namaRuas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            Ruas</label>
                    ...
                    <div>
                        <label for="dariPatok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dari
                            Patok
                            Km</label>
                    ...
                    <div>
                        <label for="kePatok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ke
                            Patok
                            Km</label>
                            ...
                            <div
                                ...
                                <ul
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="vue-checkbox" type="radio" value="1"
                                                {{ old('luas', $data->luas) == '1' ? 'checked' : '' }} name="luas"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="vue-checkbox"
                                                class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tidak
                                                ada</label>
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="react-checkbox" type="radio" value="2"
                                                {{ old('luas', $data->luas) == '2' ? 'checked' : '' }} name="luas"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="react-checkbox"
                                                class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                < 10% luas</label>
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="angular-checkbox" type="radio" value="3"
                                                {{ old('luas', $data->luas) == '3' ? 'checked' : '' }} name="luas"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="angular-checkbox"
                                                class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">10
                                                - 30% luas</label>
                                    ...
                                    <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="laravel-checkbox" type="radio" value="4"
                                                {{ old('luas', $data->luas) == '4' ? 'checked' : '' }} name="luas"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="laravel-checkbox"
                                                class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">>
                                                30% luas</label>
