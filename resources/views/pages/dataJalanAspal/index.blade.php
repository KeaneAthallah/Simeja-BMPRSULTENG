                            ...
                            @foreach ($datas as $data)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                                    ...
                                    <td class="flex space-x-2">
                                        @if (auth()->user()->role == 'staff')
                                            <button
                                                class="focus:outline-none text-white bg-nord8 hover:bg-nord8 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 kpy-2.5 dark:bg-nord8 dark:hover:bg-nord8 dark:focus:ring-nord8">
